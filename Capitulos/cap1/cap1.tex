...
Este modelo de relatório segue uma estrutura padrão que pode ser adaptada conforme as necessidades específicas do trabalho. A \refcomp{}{cap:introducao} apresenta a introdução ao tema, incluindo os objetivos e a estrutura do relatório. As seções seguintes são referentes ao desenvolvimento do tema. Geralmente, apresentam a fundamentação teórica, a metodologia de pesquisa, os experimentos realizados e a análise dos resultados. Em trabalhos de natureza de revisão, a estrutura pode seguir tópicos relacionados ao assunto pesquisado. Finalmente, a \refcomp{}{cap:conclusao} traz as conclusões do trabalho, destacando as contribuições e sugestões para trabalhos futuros.
